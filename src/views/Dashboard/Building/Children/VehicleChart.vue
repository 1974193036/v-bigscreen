<script>
import { fitChartSize, fitChartSizeVh } from '@/utils/dataUtil'
...
export default {
  ...
  methods: {
    initLine() {
      const line = document.getElementById('vehicleChart')
      this.chart = this.$echarts.init(line)
      ...
      const title = {
        ...
        padding: 0,
        top: fitChartSizeVh(17),
        left: fitChartSize(14),
      }
      const legend = {
        orient: 'vertical',
        left: 'center',
